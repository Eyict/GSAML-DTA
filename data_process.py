...
def create_dataset_for_train(dataset, fold=0):
    # load dataset
    dataset_path = 'data/' + dataset + '/'
    ...
    print()
    return train_dataset, valid_dataset, valid_drugs, train_drugs, smile_graph,train_prot_keys,valid_prots_keys


def create_dataset_for_attentionGet(dataset, fold=0):
    # load dataset
    dataset_path = 'data/' + dataset + '/'
    ...
    for key in target_key:
        ...
        g = target_to_graph(key, proteins[key], contac_path, msa_path)
        target_graph[key] = g
    target_size, target_feature, target_edge_index = target_to_graph(key, proteins[key], contac_path, msa_path)
    ...
    return valid_drugs, train_drugs, train_prot_keys, valid_prots_keys
